...
public class ProductOnBagAdapter extends BaseAdapter {
    ...
    public ProductOnBagAdapter(Context c, ArrayList<Product> _items, ProductDetailInterface myCloseInterface) {
        mContext = c;
        items = _items;
        this.closeInterface = myCloseInterface;
    }
    
    public ProductOnBagAdapter(Context c, ArrayList<Product> _items, int width, int height, ProductDetailInterface myCloseInterface) {
        mContext = c;
        items = _items;
        desiredWidth = width;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView = mInflater.inflate(R.layout.product_on_bag, null); 
        ...
        LinearLayout addToWishlist = (LinearLayout)convertView.findViewById(R.id.addToWishlistLayout);
        addToWishlist.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Log.e("click", "click add to wishlist");
				if(null!=closeInterface){
					closeInterface.onAddToWishlistClick(position, thisItem.getId());
				}
			}
		});
